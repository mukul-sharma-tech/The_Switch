...
// // Define the shape of a user object for the list
// type ListUser = {
//   _id: string;
//   name: string;
//   username: string;
...
//   users: ListUser[];
//   currentUserId?: string; // The ID of the person Browse
//   sessionUserFollowing: string[]; // An array of IDs the session user is following
...
//                       </div>
//                     </div>
//                     {/* Don't show a button for the current user's own profile in the list */}
//                     {!isCurrentUser && (
//                        <Button
