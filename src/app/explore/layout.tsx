...
//   // Get the username from the session to create a dynamic link
//   const username = session?.user?.username;

//   const navItems = [
//     { href: '/explore', icon: Home, label: 'Feed' },
//     // Use the dynamic username for the profile link
...
//               {/* Upload button styled same as others */}
//               <div
//                 className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium cursor-pointer hover:bg-primary/10 hover:text-primary transition-colors"
//               >
